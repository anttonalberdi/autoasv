...
with gzip.open(forward_input, "rt") as forward_data:
    for read1 in SeqIO.parse(forward_data, "fastq"):
        fastq_parser1.append(read1)
        read1len=len(read1)
        read1lenlist.append(read1len)

with gzip.open(reverse_input, "rt") as reverse_data:
    for read2 in SeqIO.parse(reverse_data, "fastq"):
        fastq_parser2.append(read2)
        read2len=len(read2)
        read2lenlist.append(read2len)
